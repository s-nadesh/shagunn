                ...
                <dl class="inline">
                    ...
                    <fieldset><legend>Personal Details</legend>
                        <dl class="inline">
                            ...
                            <dd>
                                <input type="radio" name="data[User][title]" value="Mr"  class="validate[required] radio title" <?php if($user['User']['title']=='Mr') { echo 'checked="checked"';  }else {  } ?>/>Mr &nbsp;
                                  <input type="radio" name="data[User][title]" value="Ms"  class="validate[required] radio title" <?php if($user['User']['title']=='Ms') { echo 'checked="checked"';  }else {  } ?>/>Ms &nbsp;
                                    <input type="radio" name="data[User][title]" value="Mrs"  class="validate[required] radio title" <?php if($user['User']['title']=='Mrs') { echo 'checked="checked"';  }else {  } ?>/>Mrs &nbsp;
                                      <input type="radio" name="data[User][title]" value="Others"  class="validate[required] radio title" <?php if($user['User']['title']=='Others') { echo 'checked="checked"';  }else {  } ?>/>Others &nbsp;
                                       <input type="text" name="data[User][other]" class="validate[required] other" <?php if($user['User']['title']!='Others') { echo 'style="display:none;"'; }  else { } ?> size="30" value="<?php echo $user['User']['other'];?>"/>
                            ...
                            <dd><input type="radio" name="data[User][martial_status]" value="Married"  class="validate[required] radio" <?php if($user['User']['martial_status']=='Married') { echo 'checked="checked"';  }else {  } ?>/>Married &nbsp;
                                  <input type="radio" name="data[User][martial_status]" value="Unmarried"  class="validate[required] radio" <?php if($user['User']['martial_status']=='Unmarried') { echo 'checked="checked"';  }else {  } ?>/>Unmarried &nbsp;      </dd>
                    ...
                    <fieldset><legend>Nomination Details</legend>
                        <dl class="inline">
                            ...
                            <dd>
                                <input type="radio" name="data[Nomination][title]" value="Mr"  class="validate[required] radio" <?php if($nomination['Nomination']['title']=='Mr') { echo 'checked="checked"';  }else {  } ?>/>Mr &nbsp;
                                  <input type="radio" name="data[Nomination][title]" value="Ms"  class="validate[required] radio" <?php if($nomination['Nomination']['title']=='Ms') { echo 'checked="checked"';  }else {  } ?>/>Ms &nbsp;
                                    <input type="radio" name="data[Nomination][title]" value="Mrs"  class="validate[required] radio" <?php if($nomination['Nomination']['title']=='Mrs') { echo 'checked="checked"';  }else {  } ?>/>Mrs &nbsp;
                    ...
                    <fieldset><legend>Bank Details</legend>
                        <dl class="inline">
                            ...
                            <input type="radio" name="data[Bankdetail][type]" value="<?php echo $accounttype['Accounttype']['account_id'];?>" class="validate[required] radio" <?php  if($bank['Bankdetail']['type']==$accounttype['Accounttype']['account_id']) { echo 'checked="checked"'; } else { } ?> /><?php echo $accounttype['Accounttype']['account_type'];?>
                    ...
                    <fieldset><legend>Other Details</legend>
                        <dl class="inline">
                           <fieldset><legend>Are you in Jewellery Business?</legend>
                            <dt></dt>
                             <dd><input type="radio" name="data[Otherdetail][jewellery]" class="jewelleryyes" value="Yes" <?php if($other['Otherdetail']['jewellery']=='Yes') { echo 'checked="checked"'; } else { }  ?>  />Yes &nbsp;
                                  <input type="radio" name="data[Otherdetail][jewellery]" class="jewelleryno" value="No"   <?php if($other['Otherdetail']['jewellery']=='No') { echo 'checked="checked"'; } else { }  ?>/>No &nbsp;
                            </dd>
                            <div class="jewellery1" <?php if($other['Otherdetail']['jewellery']=='No') { echo 'style="display:none";'; }    ?>>
                            ...
                            <dt></dt>
                             <dd><input type="radio" name="data[Otherdetail][agreement]" value="Yes" class="agreementyes"  <?php if($other['Otherdetail']['agreement']=='Yes') { echo 'checked="checked"'; } else { }  ?> />Yes &nbsp;
                                  <input type="radio" name="data[Otherdetail][agreement]" value="No"   class="agreementno"  <?php if($other['Otherdetail']['agreement']=='No') { echo 'checked="checked"'; } else { }  ?> />No &nbsp;
                            </dd>
                             <div class="jewellery2" <?php if($other['Otherdetail']['agreement']=='No') { echo 'style="display:none";'; }    ?>>
                            ...
                            <dt></dt>
                             <dd><input type="radio" name="data[Otherdetail][outlet]" value="Mall"  <?php if($other['Otherdetail']['outlet']=='Mall') { echo 'checked="checked"'; } else { }  ?>   class="outletyes" class="validate[required] radio"/>Mall &nbsp;
                                  <input type="radio" name="data[Otherdetail][outlet]" value="Other" <?php if($other['Otherdetail']['outlet']=='Other') { echo 'checked="checked"'; } else { }  ?>    class="outletno" class="validate[required] radio"/>Other &nbsp;
                            </dd>
                             <div class="jewellery3" <?php if($other['Otherdetail']['outlet']=='Other') { echo 'style="display:none";'; }    ?>>
                            ...
                            <dd><input type="text" name="data[Otherdetail][special_details]" class="validate[required]" id="special_details" size="50" value="<?php echo $other['Otherdetail']['special_details'];?>"/></dd>
                             ...
                             <div class="jewellery4" <?php if($other['Otherdetail']['outlet']=='Mall') { echo 'style="display:none";'; }    ?>>
                         ...
                         foreach ($payment as $payment) {
                           ?>
                            ...
                            <fieldset><legend>Mode of payment</legend> 
                                ...
                                <option value="Cheque"  <?php if($payment['Payment']['payment']=='Cheque') { echo 'selected="selected"'; } else { }  ?>  > Cheque</option>
                                <option value="Demand Draft"  <?php if($payment['Payment']['payment']=='Demand Draft') { echo 'selected="selected"'; } else { }  ?>  >Demand Draft</option>
                                <option value="NEFT"  <?php if($payment['Payment']['payment']=='NEFT') { echo 'selected="selected"'; } else { }  ?>  >NEFT </option>
                                <option value="RTGS"  <?php if($payment['Payment']['payment']=='RTGS') { echo 'selected="selected"'; } else { }  ?>  >RTGS</option>
                                 </select></dd>
          ...
          <fieldset><legend>Outlet Details</legend>
                    ...
                    <fieldset><legend>Document Submitted/Requirement</legend>
                     <dl class="inline">
                              ...
                              <dd> <input type="radio" id="pan1"  name="data[Franchiseeproof][pan]" value="Yes" <?php if($franchisee['Franchiseeproof']['pan']=='Yes') { echo 'checked="checked"'; } else { }  ?> class="validate[required] radio"  />Yes&nbsp;&nbsp;&nbsp;
                                   <input type="radio" id="pan2"  name="data[Franchiseeproof][pan]" value="No"  class="validate[required] radio"  <?php if($franchisee['Franchiseeproof']['pan']=='No') { echo 'checked="checked"'; } else { }  ?>/>No&nbsp;&nbsp;&nbsp;            </dd>
                                   
                                   
                            <dt><label for="name">Address Proof</label></dt>
                            <dd><input type="radio" id="checklist" class="yes"  name="data[Franchiseeproof][checklist1]" value="Yes" class="validate[required] radio"  <?php if($franchisee['Franchiseeproof']['checklist1']=='Yes') { echo 'checked="checked"'; } else { }  ?>  />Yes&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="checklist" class="no" name="data[Franchiseeproof][checklist1]" value="No"   class="validate[required] radio"  <?php if($franchisee['Franchiseeproof']['checklist1']=='No') { echo 'checked="checked"'; } else { }  ?> />No&nbsp;&nbsp;&nbsp;
                                
                                <div class="sheet" <?php if($franchisee['Franchiseeproof']['checklist1']=='No') { echo 'style="display:none";'; } ?>>
                                        <?php $emp=explode(',',$franchisee['Franchiseeproof']['proof']);?>
                                        <?php foreach ($proof as $proof) { ?>
                                        <input type="checkbox" name="data[Franchiseeproof][proof][]" class="validate[required]" <?php if(in_array($proof['Proof']['proof_id'],$emp)) { echo 'checked="checked"'; } else { } ?>  value="<?php echo $proof['Proof']['proof_id'];?>" /><?php echo $proof['Proof']['name'];?>
                                        <?php } ?>
                                 </div>
                            ...
                            <dd><input type="radio" id="bankproof"  name="data[Franchiseeproof][bankproof]" value="Yes" class="validate[required] radio" <?php if($franchisee['Franchiseeproof']['bankproof']=='Yes') { echo 'checked="checked"'; } else { }  ?>   />Yes&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="bankproof1"  name="data[Franchiseeproof][bankproof]" value="No" class="validate[required] radio"  <?php if($franchisee['Franchiseeproof']['bankproof']=='No') { echo 'checked="checked"'; } else { }  ?> />No
                            </dd>
                            
                            <dt><label for="name">Signed Franchisee Agreement </label></dt>
                            <dd><input type="radio" id="sign_proof"  name="data[Franchiseeproof][sign_proof]" value="Yes" class="validate[required] radio" <?php if($franchisee['Franchiseeproof']['sign_proof']=='Yes') { echo 'checked="checked"'; } else { }  ?>    />Yes&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="sign_proof1"  name="data[Franchiseeproof][sign_proof]" value="No"  class="validate[required] radio" <?php if($franchisee['Franchiseeproof']['sign_proof']=='No') { echo 'checked="checked"'; } else { }  ?>   />No&nbsp;&nbsp;&nbsp;
                               
                            </dd>
                            
                             <dt><label for="name">Loan Franchisee </label></dt>
                            <dd><input type="radio" id="loan"  name="data[Franchiseeproof][loan]" value="Yes" class="validate[required] radio" <?php if($franchisee['Franchiseeproof']['loan']=='Yes') { echo 'checked="checked"'; } else { }  ?>    />Yes&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="loan"  name="data[Franchiseeproof][loan]" value="No"  class="validate[required] radio" <?php if($franchisee['Franchiseeproof']['loan']=='No') { echo 'checked="checked"'; } else { }  ?>   />No&nbsp;&nbsp;&nbsp;
