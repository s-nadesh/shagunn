  ...
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
            ...
            <div id="tabs-1" >
                ...
                <form name="login" id="loginpage" action="" method="post">
                    ...
                    <a href="javascript:void(0);" id="forgot_button" >Forgot Password?</a></td>
                                                </tr>                            	
                                            </table>
                                        </td>

                                       <td width="100"><?php echo $this->Html->image('or_img.png',array('alt'=>''));  ?></td>
                    	               <td><a href="<?php echo BASE_URL;?>signin/facebook<?php if(isset($_GET['ref'])) echo "/cart" ?>"><?php echo $this->Html->image('login_fb.png',array('alt'=>''));  ?></td>
                                    </tr>	
