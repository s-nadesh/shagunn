       ...
       <a href="<?php echo BASE_URL;?>"><div class="logo"></div></a>
        ...
        <div class="top_mid"><table cellpadding="0" cellspacing="0" border="0" width="75%" align="center" class="contentText">
            	<tr>
                	...
                	<td align="left" class="bdrToprightNone"><a href="<?php echo BASE_URL;?>delivery-details">DELIVERY DETAILS</a></td>
                </tr>
            	<tr>
        ...
        <div class="top_right">
          <div class="shop_info_menu">
           ...
           <a href="<?php echo BASE_URL;?>shoppingcarts/shopping_cart"> <?php  echo $this->Html->image("cart_icn.png",array("alt" => "index"));?> Cart <?php if($this->Session->read('cart_process')!=''){
            ...
            <?php			
             if($this->Session->read('User')==''){ ?>   <li id="login"> <?php echo $this->Html->Link('Register',array('controller'=>'signin','action'=>'index'));?>&nbsp;
                <div class="Registered"></div>
              </li>
              <?php }?>
              <?php			
             if($this->Session->read('User')){ ?>
                                  <li id="login"><?php echo $this->Html->link('My Account',array('action'=>'details','controller'=>'signin')); ?> / <?php echo $this->Html->link('My Order',array('action'=>'my_order','controller'=>'orders')); ?> /  <?php echo $this->Html->link('Wish List',array('action'=>'wishlist','controller'=>'signin')); ?> / <?php  echo $this->Html->link('Logout',array('controller'=>'signin','action'=>'logout'),array('escape'=>false,'id'=>'login')); ?>
                          <?php }else{ ?>
            ...
            <div class="dropdown shagun_megamenu">
              <div id="tabs">
                ...
                <?php if(!empty($image['Productimage']['imagename'])) { ?>
                 ...
                 <a href="<?php echo BASE_URL.$cateogies['Category']['link'].'/'.$subcategory['Subcategory']['link'];?>"> <?php
echo $this->Html->image('product/small/'.$image['Productimage']['imagename'],array('border'=>0,'width'=>'170px','height'=>'120'));?></a>
         ...
         echo  $this->Html->image(
                  'product/small/'.$image['Productimage']['imagename'],array('border'=>0,'width'=>'170px','height'=>'120'))          ;?></a>
