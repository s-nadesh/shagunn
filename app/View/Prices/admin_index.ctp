  ...
  <div class="container">
    ...
    <div class="tablefooter clearfix">
     <form name="searchfilters" action="" id="myForm1" method="post" style="width:800px;float:left;padding: 5px 10px;">  
            ...
            <td><input type="radio" id="checklist" class="validate[required] radio metal" name="searchtype" value="Metals" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Metal&nbsp;&nbsp;&nbsp;
           <input type="radio" id="checklist" class="validate[required] radio stone" name="searchtype" value="Stone" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Diamond&nbsp;&nbsp;&nbsp;
            <input type="radio" id="checklist" class="validate[required] radio gemstone" name="searchtype" value="Gemstone" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Gemstone&nbsp;&nbsp;&nbsp;
          ...
          <option value="">Select</option>
            ...
            <td>&nbsp;</td><td>
            <?php if(isset($_REQUEST['searchfilter'])){			
    ...
    <table cellpadding="0" cellspacing="0" id="example" class="table gtable">
      <thead>
        <tr>
          ...
          <th align="left" ><?php echo __('Karat/Clarity/Shape');?></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="left"><?php if($price['Price']['type']=='Metals'){
