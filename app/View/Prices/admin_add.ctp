    ...
    <fieldset>
     ...
     <dl class="inline">
          <dt><label for="name">Type<?php if(!isset($this->params['pass']['0'])){ ?><span class="required">*</span><?php } ?></label></dt>
           <dd><?php if(!isset($this->params['pass']['0'])){ ?><input type="radio" id="checklist"  class="validate[required] radio metal" name="data[Price][type]" value="Metals"  />Metal&nbsp;&nbsp;&nbsp;<?php } else { if($price['Price']['type']=='Metals'){echo $price['Price']['type'];}elseif($price['Price']['type']=='Stone'){echo 'Diamond';}elseif($price['Price']['type']=='Gemstone'){echo $price['Price']['type'];} } ?>
           
                <?php if(!isset($this->params['pass']['0'])){ ?>
                <input type="radio" id="checklist" class="validate[required] radio metal" name="data[Price][type]" value="Stone"  <?php if(isset($this->params['pass']['0'])){ if($price['Price']['type']=='Stone') { echo 'checked="checked"'; } else { } }?>/>Diamond&nbsp;&nbsp;&nbsp;<?php } ?>
                 <?php if(!isset($this->params['pass']['0'])){ ?>
                <input type="radio" id="checklist" class="validate[required] radio metal" name="data[Price][type]" value="Gemstone"  <?php if(isset($this->params['pass']['0'])){ if($price['Price']['type']=='Gemstone') { echo 'checked="checked"'; } else { } }?>/>Gemstone&nbsp;&nbsp;&nbsp;</dd><?php } ?>
           ...
           <option value="">Select </option>
            ...
            <?php ?><?php } if(isset($this->params['pass']['0'])){ if($price['Price']['type']=='Stone') { 
           ...
           if(isset($this->params['pass']['0'])){
            ...
            ?>
            <div class="color" <?php  if(isset($this->params['pass']['0'])){ if($price['Price']['metalcolor_id']) {  echo 'style="display:block;"'; }  else { echo 'style="display:none";'; } }
           ...
           <option value="">Select </option>
            ...
            <?php ?><?php } if(isset($this->params['pass']['0'])){ echo $diamond['Diamond']['name']; }?></dd>
            </div>
           ...
           if(isset($this->params['pass']['0'])){
            ...
            ?>
                <div class="gem" <?php  if(isset($this->params['pass']['0'])){ if($price['Price']['type']=='Gemstone') { echo 'style="display:block;"'; }  else { echo 'style="display:none";'; } }else { echo 'style="display:none";'; } ?>>
             <dt><label for="name">Stone Shape<span class="required">*</span></label></dt> 
              ...
              <div class="stonedetails" <?php if(isset($this->params['pass']['0'])) { if($price['Price']['type']=='Metals') { echo 'style="display:none";'; }if($price['Price']['type']=='Gemstone') { echo 'style="display:none";'; }else {  echo 'style="display:block";'; } }else { echo 'style="display:none";';  }?> >
           ...
           <dd><input type="text" name="data[Price][price]" id="regpincode" onkeypress="return floatnumbers(this,event)"  class="validate[required,custom[number]]"   size="50" value=" <?php if(isset($this->params['pass']['0'])){ echo $price['Price']['price']; } else {  }?>" />
           <div class="kt" <?php if(isset($this->params['pass']['0'])) { if($price['Price']['type']=='Metals') { echo 'style="display:block";'; }else { echo 'style="display:none";'; } }?> style="display:block;" ><p><strong>(24 Kt price/gm)</strong></p></div>
           <div class="ct"<?php if(isset($this->params['pass']['0'])) { if($price['Price']['type']=='Stone') { echo 'style="display:block";'; } if($price['Price']['type']=='Gemstone' ) { echo 'style="display:block";'; } else { echo 'style="display:none";'; } }?> style="display:none;"><p><strong>(carat price)</strong></p></div>
           </dd>  
                 <div class="buttons" >
