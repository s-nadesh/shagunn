          ...
          <fieldset><legend>Metal Details</legend>
             <dl class="inline">
                      ...
                      <dl class="inline">
                        ...
                        <dd>  <input type="text" name="data[Product][making_charge]" id="making_charge"  class="validate[required,custom[integer]]" size="50" onkeypress="return intnumbers(this,event)" maxlength=10 value="<?php if (isset($this->request->data['Product']['making_charge'])) {
                                        echo $this->request->data['Product']['making_charge'];
                                    } ?>"/>&nbsp; %</dd>
                        <dt><label for="name">Width></label></dt>
                        <dd>  <input type="text" name="data[Product][width]" id="width"  class="validate[custom[number]]" size="50" onkeypress="return floatnumbers(this,event)" maxlength=10 value="<?php if (isset($this->request->data['Product']['width'])) {
                                        echo $this->request->data['Product']['width'];
                                    } ?>"/>&nbsp; mm </dd>
                                    
                         <dt><label for="name">Height</label></dt>
                        <dd>   <input type="text" name="data[Product][height]" id="height"  class="validate[custom[number]]" size="50" onkeypress="return floatnumbers(this,event)" maxlength=10 value="<?php if (isset($this->request->data['Product']['height'])) {
            ...
            <dl class="inline">
                     ...
                     <dd><input type="text" name="data[Product][vendor_making_charge]" class="validate[required,custom[integer]]" id="vendor_making_charge" size="50"  />&nbsp;%</dd>
