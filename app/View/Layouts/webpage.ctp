...
<head>
<meta charset="utf-8" />
<title><?php if(!empty($title)){echo $title;}else{echo 'Shagunn';}?> </title>

<meta name="Description" content="
<?php if(!empty($metadescription)){echo $metadescription;}else{
...
<script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                $('.top_mid a').mouseover(function () { $('.my_account_dropdown').slideDown(700); });
                $('.top_mid').mouseout(function () { $('.my_account_dropdown').slideUp(700); });
