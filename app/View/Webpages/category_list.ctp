<div class="main">
  ...
  <div class="productInfoDiv"> 
	...
	?>
    <p align="center"><?php
	/*$category = ClassRegistry::init('Category')->find('first', array('conditions' => array('link'=>$this->params['pass']['0'],'status' =>'Active'),'order'=>'category_id ASC')); 
    ...
    <?php 
      ...
      <?php
        ...
        <div  class="<?php  if($i<=2) { echo 'rings_cat'; }else { echo 'rings_cat_three ';}?>" <?php if($i!=2) { echo 'style="border-right:1px dashed #ccc;"'; } ?>>
...
<li><a href="<?php echo $categories['Category']['link']."/".$subcategories['Subcategory']['link']?>"><img  src="<?php echo BASE_URL.'img/product/small/'.$image['Productimage']['imagename']?>"border='0' width='110px' height='85px'/></a></li>
        <?php }?><?php   } ?></ul><?php  } else { echo '<div class="no_category">No Product Found</div>';}  ?>
