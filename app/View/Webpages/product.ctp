...
<div class="main">
  ...
  <div class="productInfoDiv">
    ...
    <p><h2><?php if(!empty($cats)){ echo $cats['Category']['category']; if(!empty($sub_cats)){ echo ' - '.$sub_cats['Subcategory']['subcategory'];}}else{ echo 'All Jewellery';}?></h2></p>
    <div style="border-bottom:2px solid #dba715; border-top:2px solid #dba715; width:100%; float:left; margin-bottom:10px;">
      ...
      <ul>    
        <li><a href="<?php echo BASE_URL;?><?php echo $this->request->url;?>?filter=whats_new" <?php if(isset($_REQUEST['filter'])){ if($_REQUEST['filter']=="whats_new"){ echo 'class="active"';}}?>>WHAT'S NEW</a></li> 
        <li><a href="<?php echo BASE_URL;?><?php echo $this->request->url;?>?filter=popular" <?php if(isset($_REQUEST['filter'])){ if($_REQUEST['filter']=="popular"){ echo 'class="active"';}}?>>POPULAR</a></li>
        <li><a href="<?php echo BASE_URL;?><?php echo $this->request->url;?>?filter=price&order=<?php if(isset($_REQUEST['order'])){ if($_REQUEST['order']=="asc"){echo "desc";}else{ echo "asc";}}else{echo "asc";}?>" <?php if(isset($_REQUEST['filter'])){ if($_REQUEST['filter']=="price"){ echo 'class="active"';}}?>>PRICE</a></li>
      </ul>
    ...
    <div class="productMiddleDeatil">
      ...
      <form method="get" id="left_side" name="left_side">       
        <ul>       
          ...
          <li class="bg_none">
            <input name="price" type="radio" value="1" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==1?'checked="checked"':'';}?>>
            BELOW &gt; Rs. 10,000/-</li>
          <li>
            <input name="price" type="radio" value="2" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==2?'checked="checked"':'';}?>>
             Rs. 10,000/- &gt;  Rs. 20,000/-</li>
          <li>
            <input name="price" type="radio" value="3" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==3?'checked="checked"':'';}?>>
             Rs. 20,000/- &gt;  Rs. 30,000/-</li>
          <li>
            <input name="price" type="radio" value="4" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==4?'checked="checked"':'';}?>>
             Rs. 30,000/- &gt;  Rs. 40,000/-</li>             
          <li>
            <input name="price" type="radio" value="5" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==5?'checked="checked"':'';}?>>
             Rs. 40,000/- &gt;  Rs. 50,000/-</li>
          <li>
            <input name="price" type="radio" value="6" <?php if(isset($_REQUEST['price'])){ echo $_REQUEST['price']==6?'checked="checked"':'';}?>>
             Rs. 50,000/-  &lt; above</li>           
        </ul>
        ...
        <ul>
		  ...
		  ?>
              <li class="bg_none">
            <input name="category" type="radio" value="<?php echo str_replace(' ','_',strtolower($tcat['Category']['category']));?>" class="links" <?php if(isset($this->params['pass']['0'])){ echo (str_replace(' ','_',strtolower($tcat['Category']['category']))==$this->params['pass']['0']?'checked="checked"':''); } if(isset($_REQUEST['category'])){ echo (str_replace(' ','_',strtolower($tcat['Category']['category']))==$_REQUEST['category']?'checked="checked"':''); } ?>/><?php echo $tcat['Category']['category'];?> (<?php echo $type_cats['0']['catcount'];?>)</li>
			<?php 
			}
		}
	?>
        ...
        <ul>        
         <p class="gold" rel="metal" value="purity">METAL</p>
          ...
          <li class="bg_none">
            <input name="metal" type="radio" value="<?php echo trim($metals['Metal']['metal_name']);?>" class="metals" <?php if(isset($_REQUEST['metal'])){ echo $_REQUEST['metal']==trim($metals['Metal']['metal_name'])?'checked="checked"':'';}?>>
            <?php echo $metals['Metal']['metal_name'];?></li>
			 <?php
             $m++;		
		  } ?>        
          <?php if($m>3){?>
         <a class="more" rel="noreal" <?php if(isset($_REQUEST['metal'])){ echo 'style="display:none"';}?>>
               More
            <i>+</i>
           </a><?php }?>
            <a class="less" rel="noreal" <?php if(!isset($_REQUEST['metal'])){ echo 'style="display:none"';}?>>
               Less
            <i>-</i>
           </a>
         
        </ul>
        <ul>    <div class="shape" <?php if(isset($_REQUEST['goldpurity'])){ echo 'style="height:100%"';}?>>
          ...
          <li class="bg_none">
            <input name="goldpurity" type="radio" value="<?php echo trim($purity['Purity']['purity']);?>" <?php if(isset($_REQUEST['goldpurity'])){ echo $_REQUEST['goldpurity']==trim($purity['Purity']['purity'])?'checked="checked"':'';}?>>
			...
			?></div><?php if($p>3){?>
            <a class="more" rel="noreal" <?php if(isset($_REQUEST['goldpurity'])){ echo 'style="display:none"';}?>>
               More
            <i>+</i>
           </a><?php }?>
            <a class="less" rel="noreal" <?php if(!isset($_REQUEST['goldpurity'])){ echo 'style="display:none"';}?>>
               Less
            <i>-</i>
           </a>
        </ul>
        <ul>        
           ...
           <li class="bg_none" >
         <input name="diamond" type="radio" value="<?php echo $diamond['Diamond']['name']?>" <?php if(isset($_REQUEST['diamond'])){ echo $_REQUEST['diamond']==trim($diamond['Diamond']['name'])?'checked="checked"':'';}?> />
           <?php echo $diamond['Diamond']['name'];?>
           </li>                   
           </ul>
        <ul>
      <div class="shape" <?php if(isset($_REQUEST['gemstone'])){ echo 'style="height:100%"';}?>>
           <p class="gold" rel="gemstone" value="stone" id="dia">STONES</p>             
           <?php $s=0;
		   foreach($stone as $stone) { ?>
          <li class="bg_none">
            <input name="gemstone" type="radio" value="<?php echo trim($stone['Gemstone']['stone']);?>" <?php if(isset($_REQUEST['gemstone'])){ echo trim(urldecode($_REQUEST['gemstone']))==trim($stone['Gemstone']['stone'])?'checked="checked"':'';}?>>
           <?php echo $stone['Gemstone']['stone'];?></li>
           <?php $s++; } ?> </div>
           <?php if($s>3){?>
            <a class="more" rel="noreal"  <?php if(isset($_REQUEST['gemstone'])){ echo 'style="display:none"';}?>>
               More
            <i>+</i>
           </a><?php }?>
            <a class="less" rel="noreal"  <?php if(!isset($_REQUEST['gemstone'])){ echo 'style="display:none"';}?>>
               Less
            <i>-</i>
           </a>
        ...
        <ul>
        <div class="shape" <?php if(isset($_REQUEST['shape'])){ echo 'style="height:100%"';}?>>
          <p class="gold" rel="shape" value="stone_shape">STONE SHAPE</p>
            <?php 
			$ss='0';
			foreach($shape as $shape) { ?>
          <li class="bg_none">
            <input name="shape" type="radio" value="<?php echo trim($shape['Shape']['shape']);?>" <?php if(isset($_REQUEST['shape'])){ echo $_REQUEST['shape']==trim($shape['Shape']['shape'])?'checked="checked"':'';}?>>
            <?php echo $shape['Shape']['shape'];?></li>
          <?php $ss++;} ?>
           </div>
           <?php  if($ss>3){?>
           <a class="more" rel="noreal" <?php if(isset($_REQUEST['shape'])){ echo 'style="display:none"';}?>>
               More
            <i>+</i>
           </a><?php }?>
            <a class="less" rel="noreal" <?php if(!isset($_REQUEST['shape'])){ echo 'style="display:none"';}?>>
               Less
            <i>-</i>
           </a>
        ...
        <ul>
        <div class="shape" <?php if(isset($_REQUEST['collection'])){ echo 'style="height:100%"';}?>>
          <p class="gold" rel="shape" value="stone_shape">Collections</p>
            <?php 
			$ss='0';
			foreach($collections as $collections) { ?>
          <li class="bg_none">
            <input name="collection" type="radio" value="<?php echo str_replace(' ','_',strtolower(trim($collections['Collectiontype']['collection_name'])));?>" <?php if(isset($_REQUEST['collection'])){ echo $_REQUEST['collection']==str_replace(' ','_',strtolower(trim($collections['Collectiontype']['collection_name'])))?'checked="checked"':'';}?>>
            <?php echo trim($collections['Collectiontype']['collection_name']);?></li>
          <?php $ss++;} ?>
           </div>
           <?php  if($ss>3){?>
           <a class="more" rel="noreal" <?php if(isset($_REQUEST['collection'])){ echo 'style="display:none"';}?>>
               More
            <i>+</i>
           </a><?php }?>
            <a class="less" rel="noreal" <?php if(!isset($_REQUEST['collection'])){ echo 'style="display:none"';}?>>
               Less
            <i>-</i>
           </a>
      ...
      <div class="gridproduct">
       <div class="productDiv" style="position:relative;">
          <div style="position:absolute; right:-9px;">
			...
			if(in_array('1',explode(",",$products['Product']['product_view_type']))){echo $this->Html->image('offer_img.png',array("alt" => "Image")); }
			?></div>
             <div style="position:relative;"><?php  			
			if(in_array('2',explode(",",$products['Product']['product_view_type']))){echo $this->Html->image('offer_img2.png',array("alt" => "Image")); }?></div>
          </div>
         <p style="height:133px;">
          <?php if(!empty($images['Productimage']['imagename'])) { ?>
	 <a href="<?php echo BASE_URL;?><?php echo $category['Category']['category']."/".$subcat."/".$products['Product']['product_id']."/".$Product_product_name;?>"><img src="<?php echo  BASE_URL.'img/product/small/'.$images['Productimage']['imagename']; ?>"/></a>
          ...
          <div style="border-bottom:1px solid #ccc; float:left; width:100%;">
            <p align="center">
             ...
             <a href="<?php echo BASE_URL;?><?php echo $category['Category']['category']."/".$subcat."/".$products['Product']['product_id']."/".$Product_product_name;?><?php if(isset($_REQUEST['goldpurity'])){ echo '?purity='.$_REQUEST['goldpurity'];}?>">
             <input name="" type="button" value="" class="addBtn" ></a>
        ...
        ?>
             <a href="<?php echo BASE_URL;?><?php echo $category['Category']['category']."/".$subcat."/".$products['Product']['product_id']."/".$Product_product_name;?><?php if(isset($_REQUEST['goldpurity'])){ echo '?purity='.$_REQUEST['goldpurity'];}?>"><img src="<?php echo  BASE_URL.'img/product/small/'.$images['Productimage']['imagename']; ?>"/></a>
			<?php			
          ...
          <div style="float:left; width:570px; height:50px;">
          	<h1>Rs. <?php echo indian_number_format($products[0]['totprice']);?> </h1>
          </div>
		  ...
		  ?>
          	 <strong>Metal :</strong> <?php echo $goldpurity;?>K <?php echo $products['Product']['metal_color'];?> Gold <?php if($products['Product']['stone']=="Yes"){	
          ...
          <div style="float:left; width:270px;">
          <a href="<?php echo BASE_URL;?><?php echo $category['Category']['category']."/".$subcat."/".$products['Product']['product_id']."/".$Product_product_name;?><?php if(isset($_REQUEST['goldpurity'])){ echo '?purity='.$_REQUEST['goldpurity'];}?>"><input name="" type="button" value="" class="addBtn" ></a>             
            <a href="<?php echo BASE_URL;?>/whislist/<?php if(!empty($this->params['pass']['0'])) { echo $this->params['pass']['0']; } ?>/<?php echo $products['Product']['product_id'];?>/<?php if(!empty($images)) { echo $images['Productimage']['image_id']; }?>">  <input name="" type="button" value="" class="wish_list_btn"></a>
          </div>
          <div style="clear:both;"></div>
        </div>
        </div>
...
function search_redirect(){	
	...
	request=arg.join('&');	
	window.location="<?php echo BASE_URL.$this->request->url;?>?"+request+'<?php if(isset($_REQUEST['filter'])){echo '&filter='.$_REQUEST['filter']; if(isset($_REQUEST['order'])){ echo '&order='.$_REQUEST['order'];}}?>';
}
	 ...
	 if(value == 0) {
	   ...
	   if(parseInt($('#total_page').val())>parseInt($('#current_page').val())){
			...
			$.ajax({
				  ...
				  type:'GET',
				  timeout:4000,
				  data: 'page='+display_page+'<?php if(!empty($this->params['pass']['0'])){ echo '&category='.$this->params['pass']['0']; if(!empty($this->params['pass'][1])){ echo '&subcategory='.$this->params['pass']['1'];}} if(!empty($_GET)){ $arr=$_GET; array_walk($arr, create_function('&$i,$k','$i="$k=$i";')); echo '&'.implode($arr,"&");}?>',
				  dataType: 'json',
