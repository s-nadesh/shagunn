...
<tr>                            	<td>Metals Weight</td>
                            	...
                            	<td>Color</td>
                                <td>:</td>
                                <td><input value="Yellow" type="text" name="mcolor" style="width:60px;"></td>
                            	<td>Metals</td>
                                <td>:</td>
                                <td><input value="Gold" type="text" name="mmetal" style="width:60px;"></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                ...
                <tr>                                <td>SI-IJ</td>
                                                ...
                                                <td>Setting</td>
                                                <td>:</td>
                                                <td><input type="text" name="dsettings[]" style="width:60px;"></td>
                                            </tr>                            
                                            ...
                                            <tr>
                                                <td>Shape</td>
                                                <td>:</td>
                                                <td><input type="text" name="dshape[]" style="width:60px;"></td>
