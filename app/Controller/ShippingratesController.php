        ...
        if (isset($this->request->data['submit'])) {			
            if (!empty($this->request->params['form']['importfile']['name'])) {
                ...
                foreach ($datas as $datas) {
                    if ( !empty($datas['State']) && !empty($datas['City']) && !empty($datas['Pincode']) && !empty($datas['DeliveryDays'])) {
                        $check = $this->Shippingrate->find('all', array('conditions' => array('pincode' => $datas['Pincode'])));
                        if (empty($check)) {
                            ...
                            $this->request->data['Shippingrate']['delivery_date'] = $datas['DeliveryDays'];
                            $this->request->data['Shippingrate']['taxcode'] = !empty($datas['TaxCode']) ? $datas['TaxCode'] : '';
                            $this->request->data['Shippingrate']['taxrate'] = !empty($datas['TaxRate(%)']) ? $datas['TaxRate(%)'] : '';
                            $this->request->data['Shippingrate']['created_date'] = date("Y-m-d H:i:s");
                            $this->request->data['Shippingrate']['status'] = 'Active';
